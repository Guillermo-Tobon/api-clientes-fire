...
const cron_nodemailer_1 = __importDefault(require("../nodemailer/cron-nodemailer"));
...
router.get('/api/email', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
cron.schedule('00 09 * * *', () => {
    cron_nodemailer_1.default.SendEmailCumpleanios();
});
